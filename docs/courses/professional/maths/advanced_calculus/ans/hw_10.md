...
&= \iint_{S} \cos^{k} \theta (\sin \theta \cos \phi, \sin \theta \sin \phi, \cos \theta) \cdot \\\\
((\cos \theta \cos \phi, \cos \theta \sin \phi, - \sin \theta) \times (- \sin \theta \sin \phi, \sin \theta \cos \phi, 0)) d \theta d \phi \\\\
...
$$
\begin{aligned}
\nabla \cdot \frac{(x, y, z)}{(a^{2} x^{2} + b^{2}y^{2} + c^{2} z^{2})^\frac{3}{2}} &= \frac{1}{(a^{2} x^{2} + b^{2}y^{2} + c^{2} z^{2})^{3}} ((a^{2} x^{2} + b^{2}y^{2} + c^{2} z^{2})^\frac{3}{2} - 3 (a^{2} x^{2} + b^{2}y^{2} + c^{2} z^{2})^\frac{1}{2} a x^{2} \\\\
